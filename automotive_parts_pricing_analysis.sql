...
-- View all piston ring records with customer names
...
-- Filter customers beginning with A

SELECT *
FROM customers
WHERE customer_name LIKE 'A%';

-- Filter customers beginning with A or B
...
-- Exclude one customer

SELECT *
FROM customers
WHERE customer_name <> 'B_Customer';

-- Join customer and part information
...
-- Count part numbers by customer
